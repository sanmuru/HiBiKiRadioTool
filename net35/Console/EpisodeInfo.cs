...
namespace HiBikiRadioTool
{
    ...
    {
        private readonly episode jObject;

        public int ID => this.jObject.id;
        public string Name => this.jObject.name;
        public string MediaType => this.jObject.media_type;
        ...
        public EpisodeInfo(episode jObject) => this.jObject = jObject ?? throw new ArgumentNullException(nameof(jObject));
    }
}